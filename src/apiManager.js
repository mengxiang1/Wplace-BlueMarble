...
export default class ApiManager {
  ...
  constructor(templateManager) {
    ...
    this.availableCharges = 0; // Number of charges
  }
    ...
    window.addEventListener('message', async (event) => {
      ...
      switch (endpointText) {
        ...
        case 'me': // Request to retrieve user data
          ...
          if (dataJSON['charges']) {
            this.availableCharges = Math.floor(dataJSON['charges']['count']);
          } else {
            this.availableCharges = 0;
          }
          console.log(`Blue Marble: User has ${this.availableCharges} charges available.`);
